...
func (ec *executionContext) _Query_user(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (any, error) {
		...
		return nil, fmt.Errorf(`unexpected type %T from directive, should be *github.com/drowqueen/wg-exercise/cosmo-router/users-subgraph/graph.User`, tmp)
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
	...
	res := resTmp.(*User)
	fc.Result = res
	return ec.marshalOUser2ᚖgithubᚗcomᚋdrowqueenᚋwgᚑexerciseᚋcosmoᚑrouterᚋusersᚑsubgraphᚋgraphᚐUser(ctx, field.Selections, res)
}
...
func (ec *executionContext) marshalOUser2ᚖgithubᚗcomᚋdrowqueenᚋwgᚑexerciseᚋcosmoᚑrouterᚋusersᚑsubgraphᚋgraphᚐUser(ctx context.Context, sel ast.SelectionSet, v *User) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
